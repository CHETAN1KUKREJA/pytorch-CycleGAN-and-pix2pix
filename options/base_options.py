...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument("--dataroot", required=True, help="should point to the main folder contianing the images")
        ...
        parser.add_argument("--A_Prefix", type=str, default="ct", help="chooses the prefix of the file of domain A prefix.nii.gz will be loaded")
        parser.add_argument("--B_Prefix", type=str, default="mr", help="chooses the prefix of the file of domain B prefix.nii.gz will be loaded")
